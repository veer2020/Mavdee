...
<head>
  ...
  <title>403 — Access Forbidden | <?= htmlspecialchars(SITE_NAME) ?></title>
...
<body>
  <div class="error-card">
    ...
    <p class="error-desc">You don't have permission to view this page.<br>Please log in or return to the homepage.</p>
    <div>
      <a href="/login.php" class="btn-home">Log In</a>
