...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        try {
            ...
            // Ensure unique slug
            $checkSlug = db()->prepare("SELECT COUNT(*) FROM products WHERE slug = ?");
            ...
            $stmt = db()->prepare(
                "INSERT INTO products
                 (name, slug, category_id, price, sale_price, original_price, sku, stock, low_stock_alert,
                  ...
                  occasion, weight_grams, meta_title, meta_description, created_at)
                 VALUES
                 (?, ?, ?, ?, ?, ?, ?, ?, ?,
                  ?, ?, ?, ?,
                  ?, ?, ?, ?,
            ...
            logAdminActivity('add_product', "Added product: {$input['name']}");
            setFlash('success', 'Product "' . h($input['name']) . '" added successfully.');
...
<div class="page-header">
    <h1><i class="bi bi-plus-circle me-2" style="color:#f8c146"></i>Add Product</h1>
            ...
            <div class="admin-card mb-3">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-sm-4">
                        ...
                        <input type="text" name="occasion" class="form-control" value="<?= h($input['occasion'] ?? '') ?>" placeholder="e.g. Wedding, Party">
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="admin-card mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="badge" class="form-control" value="<?= h($input['badge'] ?? '') ?>" placeholder="New, Sale, Hot…">
                </div>
                <div>
            ...
            <div class="admin-card mb-3">
                ...
                <div class="form-check mb-2">
                    <?php
                        $isChecked = !empty($input[$field]) || ($field === 'is_active' && empty($input));
                    ?>
